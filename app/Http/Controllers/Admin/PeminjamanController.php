...
class PeminjamanController extends Controller
{
    ...
    public function cek(Request $request)
    {
        ...
        if ($siswa) {
            return redirect()->route('admin.formPeminjaman', ['kode_anggota' => $request->kode_anggota]);
        }
    ...
    public function form($kode_anggota)
    {
        ...
        return view('pages.admin.peminjaman-form', compact('siswa', 'buku', 'denda', 'denda_keterlambatan', 'denda_buku_rusak', 'denda_buku_hilang'));
    }
