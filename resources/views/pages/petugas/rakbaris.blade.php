<x-petugas-layout>
    ...
    <x-content>
        <x-card>
            ...
            <x-card-body>
                <x-input-search route="{{ route('petugas.rakbaris') }}">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <x-button-delete id="{{ $data->id }}" resource="petugas/rakbaris"></x-button-delete>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
    ...
    @push('modal')
        <x-modal target="tambahRakbaris" title="Tambah Rak & Baris" size="modal-lg">
            <form method="POST" action="{{ route('petugas.tambahRakbaris') }}" enctype="multipart/form-data" class="mb-2">
                @csrf
                <div class="row mb-2">
                    <div class="col-12">
    ...
    @push('script')
        ...
        <script>
            $('#editRakbaris').on('show.bs.modal', function(event) {
                ...
                $.get('/petugas/rakbaris/' + id + '/edit', function(data) {
                    var modal = $(this);
                    ...
                    modal.find('form').attr('action', '/petugas/rakbaris/' + id + '/update');
                }.bind(this));
            });
        </script>
    @endpush
