<x-petugas-layout>
    ...
    <x-content>
        <x-card>
            ...
            <x-card-body>
                <x-input-search route="{{ route('petugas.buku') }}">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <x-button-delete id="{{ $data->id }}" resource="petugas/buku"></x-button-delete>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
    ...
    @push('modal')
        <x-modal target="tambahBuku" title="Tambah Buku" size="modal-lg">
            <form method="POST" action="{{ route('petugas.tambahBuku') }}" enctype="multipart/form-data" class="mb-2">
                @csrf
                <div class="row mb-2">
                    <div class="col-md-6">
    ...
    @push('script')
        ...
        <script>
            $('#editBuku').on('show.bs.modal', function(event) {
                ...
                $.get('/petugas/buku/' + id + '/edit', function(data) {
                    var modal = $(this);
                    ...
                    modal.find('form').attr('action', '/petugas/buku/' + id + '/update');
                }.bind(this));
            });
        </script>
