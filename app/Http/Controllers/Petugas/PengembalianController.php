...
class PengembalianController extends Controller
{
    ...
    {
        return view('pages.petugas.pengembalian');
    }
    ...
    public function cek(Request $request)
    {
        ...
        if ($siswa) {
            return redirect()->route('petugas.formPengembalian', ['kode_anggota' => $request->kode_anggota]);
        }
    ...
    public function form($kode_anggota)
    {
        ...
        return view('pages.petugas.pengembalian-form', compact('siswa', 'denda', 'riwayat'));
    }
